...
public class TestEmployee {
	...
	public static void main(String[] args) {
		...
		switch(choice) {
		case 1:
			e1=new SalariedEmployee("Rajan",new Date(2000,04,23),"HR","Designer",88888);
	    	e2=new SalariedEmployee("Arti",new Date(2000,04,23),"UX","Designer",99999);
	    	//System.out.println("net sal= "+e1.calculateSal());
	    	//System.out.println("net sal= "+e2.calculateSal());
	    	
			break;
		case 2:
			e1=new ContractEmployee("Mugdha",new Date(2000,04,23),"HR","Designer",80,3000);
	    	e2=new ContractEmployee("Tanaya",new Date(2000,04,23),"UX","Designer",80,4000);
